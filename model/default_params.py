...
default_syn_params = {
    ...
    "J_p": 0.45,
    # fraction of stdp synapses randomly distributed across the connections with the non-selective population
    "gamma_0": 0.10,
    ...
    "multapses" : True,
    # adds possibility of having a distribution of initial synaptic weights (gaussian distribution)
    "start_dist_weights" : {"allow" : False, "std": 0.01}}
...
default_stdp_params = {
    ...
    "tau_plus": 20.0,
    # Time constant of STDP window, depression (defined in postsynaptic neuron)
    "tau_minus": 20.0,
    # STDP learning rate
    "lambda": 0.001,
    # Asymmetry parameter
...
default_network_params.update({'stdp_params': default_stdp_params})
